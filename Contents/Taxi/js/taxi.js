...
$(document).ready(function(){
  $('#transit').click(function(){
    $('.transit').show();
    $('.rental-cars,.shuttles,.taxis,.app-based-ride').hide();
  });
  $('#rental-cars').click(function(){
    $('.rental-cars').show();
    $('.transit,.shuttles,.taxis,.app-based-ride').hide();
  });
  $('#shuttles').click(function(){
    $('.shuttles').show();
    $('.transit,.rental-cars,.taxis,.app-based-ride').hide();
  });
  $('#taxis').click(function(){
    $('.taxis').show();
    $('.transit,.rental-cars,.shuttles,.app-based-ride').hide();
  });
  $('#app-based-ride').click(function(){
    $('.app-based-ride').show();
    $('.transit,.rental-cars,.shuttles,.taxis ').hide();
  });
